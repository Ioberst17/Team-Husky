...
public class FontReplacerTMPro : EditorWindow
{
    private const string EditorPrefsKey = "Utilities.FontReplacerTMPro";
    private const string MenuItemName = "Utilities/Replace Fonts - TMPro";
    ...
    {
        var window = GetWindow<FontReplacerTMPro>(true, "Replace Fonts - TMPro");
    ...
    private static void ReplaceFonts(TMP_FontAsset src, TMP_FontAsset dest, bool includePrefabs)
    {
        ...
        for (var i = 0; i < SceneManager.sceneCount; i++)
        {
            ...
            {
                sceneMatches += ReplaceFonts(src, dest, go.GetComponentsInChildren<TMP_Text>(true));
            }
        }
        ...
        else
        {
            ...
            Debug.LogFormat(SceneManager.sceneCount.ToString());
        }
    }

    private static int ReplaceFonts(TMP_FontAsset src, TMP_FontAsset dest, IEnumerable<TMP_Text> texts)
    {
        var matches = 0;
